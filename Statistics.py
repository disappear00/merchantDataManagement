...
def process_files():
    ...
    try:
        ...
        for sheet in sheet_names:
            ...
            # 计算当日利润
            new_df['当日利润'] = new_df[['服务费回款', '补充险', '计提工资', '单量', '税金', '摊提费用', '本日费用']].sum(axis=1)
